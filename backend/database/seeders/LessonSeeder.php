        ...
        $lessons = [
            ...
            [
                ...
                'questions' => json_encode([
                    ...
                    ['id' => 'q5', 'type' => 'multiple_choice', 'question' => 'Pola あります/います digunakan untuk?', 'options' => ['Menunjukkan aksi', 'Menunjukkan eksistensi benda', 'Menunjukkan keinginan', 'Menunjukkan kemampuan'], 'correct_answer' => 'Menunjukkan eksistensi benda', 'explanation' => 'あります/います digunakan untuk mengatakan "ada" sesuatu. あります untuk benda mati, います untuk benda hidup.'],
                ]),
                'difficulty' => 'beginner',
                'content_type' => 'quiz',
                'passing_score' => 70,
